...
//         P2Input.txt and the output data goes into a file named P2Output.txt.
//Input: The user has to press enter to run the program.
//       The program uses data from a file named P2Input.txt
...
//         P2Input.txt and opens said file and then reads the
...
//         the data into a file called P2Output.txt.  It does this until
...
//Global Constants
const string INFILENAME = "P2Input.txt";
const string OUTFILENAME = "P2Output.txt";
