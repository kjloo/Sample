...
//based on the data only. This program uses the heap data structure.
...
class quasiUniqueQ
{
 ...
 private:
  ...
  void swap(ListNode& listA, ListNode& listB);
  ...
  int findMin(int indexA, int indexB);
