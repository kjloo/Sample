...
def parse_command_line():
    ...
    help = "Machine file (.tur)")
    parser.add_option("-t", "--tape_string", dest = "tape_string",
    help = "Tape string")

    options, args = parser.parse_args()

    if options.machine_file == None:
        options.machine_file = raw_input("Enter the name of the machine file: ")
    if options.tape_string == None:
        options.tape_string = raw_input("Enter the starting string: ")
