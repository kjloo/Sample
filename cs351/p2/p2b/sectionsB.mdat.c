...
void sectionExitSection(enum FavoriteOS favoriteOS)
{
  ...
  else
  {
    ...
    else
    {
      ...
      T_37 = countOSX == 0;
      mdat_invoke_scheduler(70);
      if (T_37)
      {
        mdat_invoke_scheduler(71);
        mdat_mutex_unlock(&roomMutex);
...
void sectionCriticalSection(enum FavoriteOS favoriteOS)
{
  ...
  mdat_invoke_scheduler(73);
  mdat_enter_section("Critical");

  mdat_invoke_scheduler(74);
  x = 3;
  mdat_invoke_scheduler(75);
  y = x * 7;
  mdat_invoke_scheduler(76);
  x = x - 1;
  mdat_invoke_scheduler(77);
  y = y + 1;
  mdat_invoke_scheduler(78);
  y = y - 1;
}
